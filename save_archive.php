<?php
/*
niceKeeper - This Application is fork from yourTwapperKeeper on Github
...
if (!(isset($_SESSION['access_token']['screen_name']))) {
	$_SESSION['notice'] = '<strong>Sorry!</strong>You must login to delete an archive.';
	header('Location: index.php');
	die;
	}

// validate user is the creator before save archive
...
// create and redirect
$result = $tk->saveArchive($id);
$_SESSION['notice'] = $result[1];
header('Location: index.php');
